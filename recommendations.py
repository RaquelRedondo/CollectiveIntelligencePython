...
# Transform th dictionary to allow item matching products recommendations
def dicTransformation(dictionary):
    newDict = {}
    for person in dictionary:
        for item in dictionary[person]:
            newDict.setdefault(item,{})
            newDict[item][person] = dictionary[person][item]
    return newDict
